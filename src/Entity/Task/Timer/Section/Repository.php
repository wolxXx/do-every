...
namespace DoEveryApp\Entity\Task\Timer\Section;
...
class Repository extends \Doctrine\ORM\EntityRepository
{
     ...
     *
     * @return \DoEveryApp\Entity\Task\Timer\Section | null
     */
    public function find($id, $lockMode = null, int|null $lockVersion = null): ?\DoEveryApp\Entity\Task\Timer\Section
    {
     ...
     * @return \DoEveryApp\Entity\Task\Timer\Section | null
     */
    public function findOneBy(array $criteria, array|null $orderBy = null): ?\DoEveryApp\Entity\Task\Timer\Section
    {
