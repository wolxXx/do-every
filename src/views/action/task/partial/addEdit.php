    ...
    <div class="row">
                ...
                <?php if(0 !== count($groups)): ?>
                    <div class="column">
                        <div>
                            ...
                            <div class="errors">
                                <?php foreach ($errorStore->getErrors('group') as $error): ?>
                                    <?= $error ?><br/>
                                <?php endforeach ?>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div>
                        ...
                        <div class="errors">
                            <?php foreach ($errorStore->getErrors('priority') as $error): ?>
                                <?= $error ?><br/>
                            <?php endforeach ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="column">
                    <div>
                        ...
                        <div class="errors">
                            <?php foreach ($errorStore->getErrors('intervalType') as $error): ?>
                                <?= $error ?><br/>
                            <?php endforeach ?>
                        </div>
                    </div>
                ...
                <div class="column">
                    <div>
                        ...
                        <div class="errors">
                            <?php foreach ($errorStore->getErrors('intervalValue') as $error): ?>
                                <?= $error ?><br/>
                            <?php endforeach ?>
                        </div>
                    </div>
                ...
                <div class="column">
                    <div>
                        ...
                        <div class="errors">
                            <?php foreach ($errorStore->getErrors('elapsingCronType') as $error): ?>
                                <?= $error ?><br/>
                            <?php endforeach ?>
                        </div>
                    </div>
        ...
        <div class="column">
            <div>
                ...
                <div class="errors">
                    <?php foreach ($errorStore->getErrors('note') as $error): ?>
                        <?= $error ?><br/>
                    <?php endforeach ?>
                </div>
            </div>
